<template>
  <v-container class="pricing mt-16 mb-16" id="pricing">
        ...
        <v-col>
          ...
          >
            <div class="mt-2 mb-2 mr-6 ml-6">
              ...
              <v-btn class="success rounded-xl mt-3 mb-8">ขอใบเสนอราคา</v-btn>
            </div>
          </v-card>
        </v-col>
        <v-col>
        ...
        <v-col>
          ...
          >
            <div class="mt-2 mb-2 mr-6 ml-6">
              ...
              <p>ต่อปี *ราคารวมภาษีมูลค่าเพิ่มแล้ว</p>
              <v-btn outlined color="white" class="rounded-xl mt-3 mb-8"
                >ขอใบเสนอราคา</v-btn
              >
            </div>
          </v-card>
